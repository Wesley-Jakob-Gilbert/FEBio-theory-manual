...
![Material Viewer](figs/Material Viewer.png) When a material is selected, the property window on the bottom of the material viewer lists the available properties that the user can change.
