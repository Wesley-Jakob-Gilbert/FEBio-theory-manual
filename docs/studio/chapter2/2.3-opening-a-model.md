...
Open the file _example.fsm_ from the _Examples_ folder of your FEBioStudio installation folder. You can do this by selecting the _****_**File** → **Open Model File...** menu item. A standard file open dialog box appears. Locate the file, select it and click on _Open_. The UI will now look something like Figure [1](#fig3).
