...
A comparison of this statement with the statement of virtual work, presented below in eq.\eqref{eq:virtual work}, establishes a clear correspondence between the virtual velocity $\delta\mathbf{v}$ and $\mathbf{v}$, and between the virtual energy density $\delta J$ and $\rho\left(\psi+\frac{1}{2}\mathbf{v}\cdot\mathbf{v}\right)$, with the latter representing the sum of the internal (free) and kinetic energy densities.
