...
where $\kappa$ is the bulk viscosity and $\mu$ is the shear viscosity (which may be a function of the rate of deformation in the case of a non-Newtonian fluid), see Eq.[(5.16-1)](../chapter5/5.16-viscous-fluids.md#mjx-eqn:eq:viscous-stress) in Section [Viscous Fluids](../chapter5/5.16-viscous-fluids.md#sec:Viscous-Fluids). From this result we conclude that the wall shear stress is
