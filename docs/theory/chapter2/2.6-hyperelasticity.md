...
A material is incompressible when its mass density remains constant, $\rho=\rho_{r}$, or equivalently according to eq.[eq87](#eq87), its relative volume satisfies
