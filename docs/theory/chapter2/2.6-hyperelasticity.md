...
In the transversely isotropic constitutive models described in Chapter [chap:Constitutive-Models](#chap-constitutive-models) it is further assumed that the strain energy function can be split into the following terms:
...
[^2.6-11]: G{\"u}ltekin, Osman; Dal, H{\"u}sn{\"u}; Holzapfel, Gerhard A. "On the quasi-incompressible finite element analysis of anisotropic hyperelastic materials." *Computational mechanics*, vol. 63, pp. 443--453 (2019).
